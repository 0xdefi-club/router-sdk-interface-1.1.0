          ...
          (g.prototype = {
            ...
            abrupt: function (t, e) {
              ...
              return (
                (i.type = t),
                (i.arg = e),
                u ? ((this.method = 'next'), (this.next = u.finallyLoc), s) : this.complete(i)
              )
            },
...
var _ = (function (t) {
    ...
    function t(t) {
      ...
      for (var u, a = P(e); !(u = a()).done; ) {
        var c = u.value,
          ...
          s = c.outputAmount,
          l = new _(c.routev2)
        this.routes.push(l), this.swaps.push({ route: l, inputAmount: p, outputAmount: s })
      }
      ...
      for (
        ...
        for (var k, R = E.value.route, N = P(R.pools); !(k = N()).done; ) {
          var F = k.value
          R.protocol == exports.Protocol.V3
            ? g.add(i.Pool.getAddress(F.token0, F.token1, F.fee))
            : g.add(d.Pair.getAddress(F.token0, F.token1))
        }
      x != g.size && o(!1)
    }
    var e,
                ...
                switch ((e.prev = e.next)) {
                  case 0:
                    for (u = [], a = [], c = P(n); !(p = c()).done; )
                      (m = new d.Trade((l = (s = p.value).routev2), s.amount, o)),
                        u.push({ routev2: l, inputAmount: m.inputAmount, outputAmount: m.outputAmount })
                    f = P(r)
                  case 4:
                    if ((h = f()).done) {
                      e.next = 13
                  ...
                  case 8:
                    a.push({ routev3: y, inputAmount: (T = e.sent).inputAmount, outputAmount: T.outputAmount })
                  case 11:
                    e.next = 4
                    break
                  case 13:
                    return e.abrupt('return', new t({ v2Routes: u, v3Routes: a, tradeType: o }))
                  case 14:
                  case 'end':
                    return e.stop()
                }
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    ;(c = new d.Trade(n, r, o)),
                      (u = [{ routev2: n, inputAmount: c.inputAmount, outputAmount: c.outputAmount }]),
                      (a = []),
                      (e.next = 13)
                    break
                  case 7:
                  ...
                  case 9:
                    ;(a = [{ routev3: n, inputAmount: (p = e.sent).inputAmount, outputAmount: p.outputAmount }]),
                      (u = [])
                  case 13:
                    return e.abrupt('return', new t({ v2Routes: u, v3Routes: a, tradeType: o }))
                  case 14:
      ...
      (e = [
        ...
        },
        {
          ...
          get: function () {
            ...
            for (
              var t, e = c.CurrencyAmount.fromRawAmount(this.outputAmount.currency, 0), n = P(this.swaps);
              !(t = n()).done;
  ...
  b = n.BigInt(0),
  M = new c.Percent(n.BigInt(50), n.BigInt(100)),
  C = (function () {
    function t() {}
    return (
      (t.encodeV2Swap = function (e, n, r, o) {
        ...
        return e.tradeType === c.TradeType.EXACT_INPUT
          ? t.INTERFACE.encodeFunctionData('swapExactTokensForTokens', [u, o ? 0 : a, p, s])
          : t.INTERFACE.encodeFunctionData('swapTokensForExactTokens', [a, u, p, s])
      }),
      ...
      (t.encodeSwaps = function (e, n, r) {
        if (e instanceof F) {
          ...
          for (var u, a = [], p = P(e.swaps); !(u = p()).done; ) {
            ...
            l.protocol == exports.Protocol.V2
              ? a.push(new d.Trade(l, e.tradeType == c.TradeType.EXACT_INPUT ? m : f, e.tradeType))
              : l.protocol == exports.Protocol.V3 &&
                a.push(
                  i.Trade.createUncheckedTrade({ route: l, inputAmount: m, outputAmount: f, tradeType: e.tradeType })
                )
          }
          e = a
        }
        ...
        for (var x, g = P(e); !(x = g()).done; ) {
          ...
          else for (var k, R = P(t.encodeV3Swap(I, n, E, w)); !(k = R()).done; ) y.push(k.value)
        }
      ...
      (t.swapCallParameters = function (e, n) {
        ...
        return (
          r.routerMustCustody &&
            o.push(
              r.outputIsNative
                ? w.encodeUnwrapWETH9(s.quotient, n.recipient, n.fee)
                : w.encodeSweepToken(u.outputAmount.currency.wrapped, s.quotient, n.recipient, n.fee)
            ),
          a &&
            (u.tradeType === c.TradeType.EXACT_OUTPUT || t.riskOfPartialFill(e)) &&
            o.push(i.Payments.encodeRefundETH()),
          { calldata: A.encodeMulticall(o, n.deadlineOrPreviousBlockhash), value: i.toHex(a ? p.quotient : b) }
        )
      }),
      (t.swapAndAddCallParameters = function (e, n, r, u, a, p) {
        ...
        N.greaterThan(c.CurrencyAmount.fromRawAmount(P.currency, 0)) &&
          d.push(m ? w.encodeWrapETH(N.quotient) : w.encodePull(R, N.quotient)),
          d.push(l ? w.encodeWrapETH(I.quotient) : w.encodePull(k, I.quotient)),
          a !== exports.ApprovalTypes.NOT_REQUIRED && d.push(y.encodeApprove(k, a)),
          p !== exports.ApprovalTypes.NOT_REQUIRED && d.push(y.encodeApprove(R, p))
        var _,
        ...
        return (
          ...
          d.push(l ? w.encodeUnwrapWETH9(b) : w.encodeSweepToken(k, b)),
          d.push(m ? w.encodeUnwrapWETH9(b) : w.encodeSweepToken(R, b)),
          (_ = l ? h.wrapped.add(I.wrapped).quotient : m ? N.quotient : b),
          { calldata: A.encodeMulticall(d, n.deadlineOrPreviousBlockhash), value: _.toString() }
        )
      }),
      ...
      (t.v3TradeWithHighPriceImpact = function (t) {
        return !(t instanceof d.Trade) && t.priceImpact.greaterThan(M)
      }),
...
;(C.INTERFACE = new r.Interface(s.abi)),
  (exports.ADDRESS_THIS = m),
  (exports.ApproveAndCall = y),
  (exports.MSG_SENDER = l),
  (exports.MulticallExtended = A),
  (exports.ONE = h),
  (exports.PaymentsExtended = w),
  (exports.RouteV2 = _),
  (exports.RouteV3 = O),
  (exports.SwapRouter = C),
  (exports.Trade = F),
  (exports.ZERO = f),
  (exports.isMint = v)
